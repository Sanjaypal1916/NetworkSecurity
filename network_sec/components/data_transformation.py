...
class data_transformation():
    ...
    def get_data_transformer_object(self) -> Pipeline:
        try : 
            imputer : KNNImputer = KNNImputer(allconstants.DATA_TRANSFORMATION_IMPUTER_PARAMS)
            pipeline : Pipeline = Pipeline([("imputer", imputer)])
    ...
    def initiate_data_transformation(self):
        try: 
            ...
            test_transformed_data = preprocessor.fit_transform(input_test_data)
            ...
            save_numpy_array_data(self.datatransform.transformed_train_file_path, array=train_arr)
            save_numpy_array_data(self.datatransform.transformed_test_file_path, array=test_arr)
            ...
            dataTransformationArtifact = dataTransformationArtifact(
                ...
                transformed_train_file_path = self.datatransform.transformed_test_file_path, 
